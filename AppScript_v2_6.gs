...
'#btn-refresh{font-size:11px;padding:5px 10px;cursor:pointer}\n' +
...
'<header>\n' +
'  <div class="brand-row">\n' +
'    <div class="brand">DASHBOARD GIAO BAN — PHÒNG VT-TBYT<small>Bệnh viện K — 4 tổ: Kỹ thuật / Hồ sơ / Vật tư / Kho · v2.6 · lazy-load optimized</small></div>\n' +
